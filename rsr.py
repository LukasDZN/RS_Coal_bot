...
def bank():
    try:
        ...
        pyautogui.click()
        time.sleep(5)
        t,u,m,n = pyautogui.locateOnScreen('bank.png')
        ...
        v,b,n,m = pyautogui.locateOnScreen('openbank.png')
        pyautogui.moveTo(v, b, duration=0)
        pyautogui.click()
        time.sleep(1)
        print('Depozited all items')
        a,s,d,f = pyautogui.locateOnScreen('pickaxe.png')
        ...
        time.sleep(3)
        #Rock finder
        x,y,w,h = pyautogui.locateOnScreen('rock.png')
